...
- `docs/guides/GSD_VS_SUPERPOWERS.md` — GSD vs Superpowers cheat sheet: when to use which, decision map, recommended flows (large/small/bug), composition with gstack and CE
