...
<required_reading>
@/Users/jaywest/.claude/get-shit-done/references/ui-brand.md
</required_reading>
...
```
Task(
  prompt="Read /Users/jaywest/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/jaywest/.claude/get-shit-done/templates/VALIDATION.md`
