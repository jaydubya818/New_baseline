...
2. **Spawn executor agents:**
   ...
   Task(
     ...
     prompt="
       ...
       @/Users/jaywest/.claude/get-shit-done/references/tdd.md
       </execution_context>
...
Read and follow `/Users/jaywest/.claude/get-shit-done/workflows/transition.md`, passing through the `--auto` flag so it propagates to the next phase invocation.
